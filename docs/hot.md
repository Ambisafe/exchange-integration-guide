...
First you need to make your Hot Wallet Address activated to accept ETH in a WEI4 way:
  ...
  * Open [Ambisafe Ethereum Utils](https://rawgit.com/Ambisafe/etoken-lib/master/utils/index.html)
...
Preconditions:
  ...
  * You have [EtherSweeper](http://ethersweeper-docs.ambisafe.co), can be bought in [Ambisafe Store](https://www.ambisafe.co/product/list)
...
********
Will you have any questions, don't hasitate to ask through contacting [support@ambisafe.co](mailto:support@ambisafe.co)
